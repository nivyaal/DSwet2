...
//Line Number: 16
ASSERT_TEST(RemoveCourse(DS1,-15)==INVALID_INPUT);
//Line Number: 17
...
//Line Number: 26
ASSERT_TEST(AddCourse(DS1,-24)==INVALID_INPUT);
//Line Number: 27
...
ASSERT_TEST(RemoveCourse(DS1,5)==FAILURE);
//Line Number: 37
ASSERT_TEST(AddCourse(DS1,-33)==INVALID_INPUT);
//Line Number: 38
...
ASSERT_TEST(RemoveCourse(DS1,15)==SUCCESS);
//Line Number: 83
ASSERT_TEST(AddCourse(DS1,-77)==INVALID_INPUT);
//Line Number: 84
ASSERT_TEST(AddCourse(DS1,13)==FAILURE);
//Line Number: 85
ASSERT_TEST(AddCourse(DS1,7)==FAILURE);
//Line Number: 86
ASSERT_TEST(RemoveCourse(DS1,-79)==INVALID_INPUT);
//Line Number: 87
ASSERT_TEST(RemoveCourse(DS1,16)==SUCCESS);
//Line Number: 88
ASSERT_TEST(AddCourse(DS1,-80)==INVALID_INPUT);
//Line Number: 89
ASSERT_TEST(AddCourse(DS1,1)==FAILURE);
//Line Number: 90
...
ASSERT_TEST(AddCourse(DS1,14)==FAILURE);
//Line Number: 93
ASSERT_TEST(AddCourse(DS1,-84)==INVALID_INPUT);
//Line Number: 94
ASSERT_TEST(AddCourse(DS1,20)==SUCCESS);
//Line Number: 95
ASSERT_TEST(AddCourse(DS1,14)==FAILURE);
...
ASSERT_TEST(RemoveCourse(DS1,1)==FAILURE);
//Line Number: 114
ASSERT_TEST(AddCourse(DS1,-104)==INVALID_INPUT);
//Line Number: 115
ASSERT_TEST(AddCourse(DS1,19)==SUCCESS);
//Line Number: 116
ASSERT_TEST(RemoveCourse(DS1,17)==FAILURE);
//Line Number: 117
ASSERT_TEST(AddCourse(DS1,8)==FAILURE);
//Line Number: 118
...
ASSERT_TEST(AddCourse(DS1,10)==FAILURE);
//Line Number: 131
ASSERT_TEST(RemoveCourse(DS1,-120)==INVALID_INPUT);
//Line Number: 132
ASSERT_TEST(AddCourse(DS1,7)==SUCCESS);
//Line Number: 133
ASSERT_TEST(AddCourse(DS1,5)==FAILURE);
...
ASSERT_TEST(RemoveCourse(DS1,19)==SUCCESS);
//Line Number: 140
ASSERT_TEST(RemoveCourse(DS1,-128)==INVALID_INPUT);
//Line Number: 141
ASSERT_TEST(AddCourse(DS1,19)==SUCCESS);
//Line Number: 142
ASSERT_TEST(RemoveCourse(DS1,20)==FAILURE);
...
ASSERT_TEST(RemoveCourse(DS1,18)==FAILURE);
//Line Number: 144
ASSERT_TEST(AddCourse(DS1,-131)==INVALID_INPUT);
//Line Number: 145
ASSERT_TEST(AddCourse(DS1,18)==SUCCESS);
//Line Number: 146
ASSERT_TEST(AddCourse(DS1,17)==SUCCESS);
...
ASSERT_TEST(RemoveCourse(DS1,6)==FAILURE);
//Line Number: 167
ASSERT_TEST(AddCourse(DS1,11)==FAILURE);
//Line Number: 168
ASSERT_TEST(AddCourse(DS1,15)==SUCCESS);
//Line Number: 169
ASSERT_TEST(AddCourse(DS1,7)==FAILURE);
...
ASSERT_TEST(AddCourse(DS1,10)==FAILURE);
//Line Number: 172
ASSERT_TEST(RemoveCourse(DS1,-158)==INVALID_INPUT);
//Line Number: 173
ASSERT_TEST(RemoveCourse(DS1,4)==FAILURE);
//Line Number: 174
ASSERT_TEST(AddCourse(DS1,5)==FAILURE);
...
ASSERT_TEST(RemoveCourse(DS1,11)==SUCCESS);
//Line Number: 177
ASSERT_TEST(AddCourse(DS1,-162)==INVALID_INPUT);
//Line Number: 178
ASSERT_TEST(AddCourse(DS1,17)==FAILURE);
//Line Number: 179
ASSERT_TEST(RemoveCourse(DS1,6)==FAILURE);
...
ASSERT_TEST(AddCourse(DS1,12)==FAILURE);
//Line Number: 184
ASSERT_TEST(RemoveCourse(DS1,-168)==INVALID_INPUT);
//Line Number: 185
ASSERT_TEST(RemoveCourse(DS1,18)==FAILURE);
//Line Number: 186
ASSERT_TEST(AddCourse(DS1,8)==FAILURE);
...
ASSERT_TEST(RemoveCourse(DS1,5)==SUCCESS);
//Line Number: 203
ASSERT_TEST(AddCourse(DS1,-186)==INVALID_INPUT);
//Line Number: 204
ASSERT_TEST(AddCourse(DS1,17)==FAILURE);
//Line Number: 205
ASSERT_TEST(AddCourse(DS1,11)==SUCCESS);
...
ASSERT_TEST(AddCourse(DS1,4)==SUCCESS);
//Line Number: 208
ASSERT_TEST(AddCourse(DS1,-190)==INVALID_INPUT);
//Line Number: 209
ASSERT_TEST(RemoveCourse(DS1,5)==FAILURE);
//Line Number: 210
ASSERT_TEST(RemoveCourse(DS1,15)==SUCCESS);
...
ASSERT_TEST(*classID==9);
//Line Number: 612
ASSERT_TEST(RemoveCourse(DS2,20)==SUCCESS);
//Line Number: 613
ASSERT_TEST(AddClass(DS2,12,classID)==SUCCESS);
ASSERT_TEST(*classID==10);
//Line Number: 614
...
ASSERT_TEST(*classID==6);
//Line Number: 618
ASSERT_TEST(AddCourse(DS2,19)==FAILURE);
//this one screws me3
//Line Number: 619
ASSERT_TEST(AddClass(DS2,8,classID)==FAILURE);
//Line Number: 620
...
//this one screws me3
//Line Number: 641
ASSERT_TEST(AddClass(DS2,4,classID)==FAILURE);
//Line Number: 642
...
ASSERT_TEST(*classID==14);
//Line Number: 672
ASSERT_TEST(RemoveCourse(DS2,17)==FAILURE);
//Line Number: 673
ASSERT_TEST(AddClass(DS2,2,classID)==SUCCESS);
ASSERT_TEST(*classID==8);
//Line Number: 674
...
ASSERT_TEST(*classID==6);
//Line Number: 714
ASSERT_TEST(AddCourse(DS2,1)==FAILURE);
//Line Number: 715
ASSERT_TEST(AddClass(DS2,19,classID)==SUCCESS);
ASSERT_TEST(*classID==12);
//Line Number: 716
...
//Line Number: 762
ASSERT_TEST(RemoveCourse(DS2,12)==FAILURE);
//this one screws me3
//Line Number: 763
ASSERT_TEST(AddClass(DS2,12,classID)==FAILURE);
//Line Number: 764
...
ASSERT_TEST(*classID==12);
//Line Number: 798
ASSERT_TEST(RemoveCourse(DS2,11)==FAILURE);
//Line Number: 799
ASSERT_TEST(AddClass(DS2,4,classID)==SUCCESS);
ASSERT_TEST(*classID==5);
//Line Number: 800
...
ASSERT_TEST(*classID==3);
//Line Number: 816
ASSERT_TEST(RemoveCourse(DS2,6)==SUCCESS);
//Line Number: 817
ASSERT_TEST(AddClass(DS2,17,classID)==SUCCESS);
ASSERT_TEST(*classID==4);
//Line Number: 818
...
//this one screws me3
//Line Number: 819
ASSERT_TEST(AddClass(DS2,6,classID)==FAILURE);
//this one screws me3
//Line Number: 820
ASSERT_TEST(AddClass(DS2,11,classID)==FAILURE);
//Line Number: 821
...
ASSERT_TEST(AddClass(DS2,5,classID)==FAILURE);
//Line Number: 900
ASSERT_TEST(RemoveCourse(DS2,16)==FAILURE);
//Line Number: 901
ASSERT_TEST(AddClass(DS2,2,classID)==SUCCESS);
...
ASSERT_TEST(*classID==9);
//Line Number: 1050
ASSERT_TEST(RemoveCourse(DS2,10)==FAILURE);
//Line Number: 1051
ASSERT_TEST(AddClass(DS2,15,classID)==SUCCESS);
ASSERT_TEST(*classID==10);
//Line Number: 1052
...
ASSERT_TEST(*classID==26);
//Line Number: 1068
ASSERT_TEST(RemoveCourse(DS2,2)==SUCCESS);
//Line Number: 1069
ASSERT_TEST(AddClass(DS2,15,classID)==SUCCESS);
ASSERT_TEST(*classID==11);
//Line Number: 1070
...
//this one screws me3
//Line Number: 1088
ASSERT_TEST(AddClass(DS2,20,classID)==FAILURE);
//Line Number: 1089
ASSERT_TEST(AddClass(DS2,17,classID)==SUCCESS);
ASSERT_TEST(*classID==21);
//Line Number: 1090
...
//this one screws me3
//Line Number: 1094
ASSERT_TEST(AddClass(DS2,2,classID)==FAILURE);
//Line Number: 1095
ASSERT_TEST(AddClass(DS2,19,classID)==SUCCESS);
ASSERT_TEST(*classID==27);
//Line Number: 1096
...
ASSERT_TEST(*classID==1);
//Line Number: 1110
ASSERT_TEST(RemoveCourse(DS2,2)==FAILURE);
//Line Number: 1111
ASSERT_TEST(AddClass(DS2,-16,classID)==INVALID_INPUT);
//Line Number: 1112
ASSERT_TEST(AddClass(DS2,6,classID)==SUCCESS);
...
ASSERT_TEST(AddClass(DS2,4,classID)==FAILURE);
//Line Number: 1128
ASSERT_TEST(RemoveCourse(DS2,20)==FAILURE);
//Line Number: 1129
ASSERT_TEST(AddClass(DS2,17,classID)==SUCCESS);
ASSERT_TEST(*classID==22);
//this one screws me3
...
ASSERT_TEST(*classID==31);
//Line Number: 1152
ASSERT_TEST(AddCourse(DS2,8)==FAILURE);
//Line Number: 1153
ASSERT_TEST(AddClass(DS2,9,classID)==SUCCESS);
ASSERT_TEST(*classID==26);
//this one screws me3
...
//Line Number: 1225
ASSERT_TEST(WatchClass(DS3,6,0,2)==SUCCESS);
...
//this one screws me 1
//Line Number: 1249
ASSERT_TEST(WatchClass(DS3,8,0,9)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,8,0,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==11);
//this one screws me 1
//Line Number: 1250
ASSERT_TEST(WatchClass(DS3,20,0,6)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,20,0,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==6);
//this one screws me 1
//Line Number: 1251
ASSERT_TEST(WatchClass(DS3,11,0,10)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,11,0,timeviewed)==SUCCESS);
...
//this one screws me 1
//Line Number: 1253
ASSERT_TEST(WatchClass(DS3,5,1,9)==SUCCESS);
...
//this one screws me 1
//Line Number: 1255
ASSERT_TEST(WatchClass(DS3,8,1,2)==SUCCESS);
...
//this one screws me 1
//Line Number: 1272
ASSERT_TEST(WatchClass(DS3,20,2,7)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,20,2,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==7);
//this one screws me 1
//Line Number: 1273
ASSERT_TEST(WatchClass(DS3,20,1,10)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,20,1,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==10);
//this one screws me 1
//Line Number: 1274
ASSERT_TEST(WatchClass(DS3,1,1,7)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,1,1,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==7);
//this one screws me 1
//Line Number: 1275
ASSERT_TEST(WatchClass(DS3,12,0,6)==SUCCESS);
...
//this one screws me 1
//Line Number: 1276
ASSERT_TEST(WatchClass(DS3,6,2,10)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,6,2,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==10);
//this one screws me 1
//Line Number: 1277
ASSERT_TEST(WatchClass(DS3,5,2,9)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,5,2,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==9);
//this one screws me 1
//Line Number: 1278
ASSERT_TEST(WatchClass(DS3,13,1,2)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,13,1,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==2);
//this one screws me 1
//Line Number: 1279
ASSERT_TEST(WatchClass(DS3,5,1,2)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,5,1,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==11);
//this one screws me 1
//Line Number: 1280
ASSERT_TEST(WatchClass(DS3,12,1,7)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,12,1,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==11);
//Line Number: 1281
...
//this one screws me 1
//Line Number: 1295
ASSERT_TEST(WatchClass(DS3,9,0,10)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,9,0,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==10);
//this one screws me 1
//Line Number: 1296
ASSERT_TEST(WatchClass(DS3,8,3,9)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,8,3,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==9);
//this one screws me 1
//Line Number: 1297
ASSERT_TEST(WatchClass(DS3,13,3,1)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,13,3,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==1);
//this one screws me 1
//Line Number: 1298
ASSERT_TEST(WatchClass(DS3,5,2,5)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,5,2,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==14);
//this one screws me 1
//Line Number: 1299
ASSERT_TEST(WatchClass(DS3,6,1,10)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,6,1,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==10);
//this one screws me 1
//Line Number: 1300
ASSERT_TEST(WatchClass(DS3,13,0,2)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,13,0,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==2);
//this one screws me 1
//Line Number: 1301
ASSERT_TEST(WatchClass(DS3,13,1,6)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,13,1,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==8);
//Line Number: 1302
ASSERT_TEST(AddCourse(DS3,18)==SUCCESS);
...
//Line Number: 1309
ASSERT_TEST(RemoveCourse(DS3,9)==SUCCESS);
//Line Number: 1310
...
//this one screws me 1
//Line Number: 1320
ASSERT_TEST(WatchClass(DS3,4,2,1)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,4,2,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==1);
//this one screws me 1
//Line Number: 1321
ASSERT_TEST(WatchClass(DS3,15,1,10)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,15,1,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==10);
//this one screws me 1
//Line Number: 1322
ASSERT_TEST(WatchClass(DS3,6,3,3)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,6,3,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==3);
//this one screws me 1
//Line Number: 1323
ASSERT_TEST(WatchClass(DS3,6,2,5)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,6,2,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==15);
//this one screws me 1
//Line Number: 1324
ASSERT_TEST(WatchClass(DS3,15,0,1)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,15,0,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==1);
//this one screws me 1
//Line Number: 1325
ASSERT_TEST(WatchClass(DS3,6,3,9)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,6,3,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==12);
//this one screws me 1
//Line Number: 1326
ASSERT_TEST(WatchClass(DS3,5,0,4)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,5,0,timeviewed)==SUCCESS);
...
//this one screws me 1
//Line Number: 1343
ASSERT_TEST(WatchClass(DS3,17,1,5)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,17,1,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==5);
//this one screws me 1
//Line Number: 1344
ASSERT_TEST(WatchClass(DS3,17,1,3)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,17,1,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==8);
//this one screws me 1
//Line Number: 1345
ASSERT_TEST(WatchClass(DS3,12,0,5)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,12,0,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==5);
//this one screws me 1
//Line Number: 1346
ASSERT_TEST(WatchClass(DS3,15,1,5)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,15,1,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==15);
//this one screws me 1
//Line Number: 1347
ASSERT_TEST(WatchClass(DS3,15,0,7)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,15,0,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==8);
//this one screws me 1
//Line Number: 1348
ASSERT_TEST(WatchClass(DS3,15,0,2)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,15,0,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==10);
//this one screws me 1
//Line Number: 1349
...
//this one screws me 1
//Line Number: 1350
ASSERT_TEST(WatchClass(DS3,17,0,8)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,17,0,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==8);
//this one screws me 1
//Line Number: 1351
ASSERT_TEST(WatchClass(DS3,7,0,9)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,7,0,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==9);
//this one screws me 1
//Line Number: 1352
ASSERT_TEST(WatchClass(DS3,7,0,8)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,7,0,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==17);
//Line Number: 1353
ASSERT_TEST(AddCourse(DS3,9)==SUCCESS);
...
//this one screws me 1
//Line Number: 1368
ASSERT_TEST(WatchClass(DS3,14,2,1)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,14,2,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==1);
//this one screws me 1
//Line Number: 1369
ASSERT_TEST(WatchClass(DS3,15,1,9)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,15,1,timeviewed)==SUCCESS);
...
//this one screws me 1
//Line Number: 1371
ASSERT_TEST(WatchClass(DS3,7,1,8)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,7,1,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==8);
//this one screws me 1
//Line Number: 1372
ASSERT_TEST(WatchClass(DS3,9,1,10)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,9,1,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==10);
//this one screws me 1
//Line Number: 1373
ASSERT_TEST(WatchClass(DS3,7,0,1)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,7,0,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==18);
//this one screws me 1
//Line Number: 1374
ASSERT_TEST(WatchClass(DS3,15,2,9)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,15,2,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==9);
//this one screws me 1
//Line Number: 1375
ASSERT_TEST(WatchClass(DS3,9,0,5)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,9,0,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==5);
//this one screws me 1
//Line Number: 1376
ASSERT_TEST(WatchClass(DS3,12,0,4)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,12,0,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==15);
//Line Number: 1377
ASSERT_TEST(RemoveCourse(DS3,13)==SUCCESS);
//Line Number: 1378
ASSERT_TEST(AddCourse(DS3,11)==SUCCESS);
//Line Number: 1379
ASSERT_TEST(AddCourse(DS3,20)==SUCCESS);
...
//this one screws me 1
//Line Number: 1392
ASSERT_TEST(WatchClass(DS3,17,3,1)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,17,3,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==1);
//this one screws me 1
//Line Number: 1393
ASSERT_TEST(WatchClass(DS3,14,0,8)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,14,0,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==8);
//this one screws me 1
//Line Number: 1394
ASSERT_TEST(WatchClass(DS3,12,0,2)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,12,0,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==17);
//this one screws me 1
//Line Number: 1395
ASSERT_TEST(WatchClass(DS3,7,0,2)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,7,0,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==20);
//this one screws me 1
//Line Number: 1396
ASSERT_TEST(WatchClass(DS3,9,2,4)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,9,2,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==4);
//this one screws me 1
//Line Number: 1397
ASSERT_TEST(WatchClass(DS3,12,0,9)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,12,0,timeviewed)==SUCCESS);
...
//this one screws me 1
//Line Number: 1413
ASSERT_TEST(WatchClass(DS3,5,0,9)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,5,0,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==22);
//this one screws me 1
//Line Number: 1414
ASSERT_TEST(WatchClass(DS3,7,2,10)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,7,2,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==10);
//this one screws me 1
//Line Number: 1415
ASSERT_TEST(WatchClass(DS3,17,5,5)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,17,5,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==5);
//this one screws me 1
//Line Number: 1416
ASSERT_TEST(WatchClass(DS3,6,1,1)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,6,1,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==11);
//this one screws me 1
//Line Number: 1417
ASSERT_TEST(WatchClass(DS3,15,3,3)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,15,3,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==3);
//this one screws me 1
//Line Number: 1418
ASSERT_TEST(WatchClass(DS3,6,1,3)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,6,1,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==14);
//this one screws me 1
//Line Number: 1419
...
ASSERT_TEST(*classID==5);
//Line Number: 1428
ASSERT_TEST(AddClass(DS3,18,classID)==SUCCESS);
ASSERT_TEST(*classID==0);
//Line Number: 1429
ASSERT_TEST(AddClass(DS3,10,classID)==SUCCESS);
ASSERT_TEST(*classID==1);
...
//this one screws me 1
//Line Number: 1434
ASSERT_TEST(WatchClass(DS3,14,0,7)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,14,0,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==15);
//this one screws me 1
//Line Number: 1435
ASSERT_TEST(WatchClass(DS3,14,5,8)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,14,5,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==8);
//this one screws me 1
//Line Number: 1436
ASSERT_TEST(WatchClass(DS3,15,4,2)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,15,4,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==2);
//this one screws me 1
//Line Number: 1437
ASSERT_TEST(WatchClass(DS3,18,0,7)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,18,0,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==7);
//this one screws me 1
//Line Number: 1438
ASSERT_TEST(WatchClass(DS3,5,9,9)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,5,9,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==9);
//this one screws me 1
//Line Number: 1439
ASSERT_TEST(WatchClass(DS3,18,0,7)==SUCCESS);
...
//this one screws me 1
//Line Number: 1440
ASSERT_TEST(WatchClass(DS3,11,1,7)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,11,1,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==7);
//this one screws me 1
//Line Number: 1441
ASSERT_TEST(WatchClass(DS3,6,2,8)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,6,2,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==23);
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@INVALID INSERTS @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
//Line Number: 1442
ASSERT_TEST(WatchClass(DS3,15,-5,5)==INVALID_INPUT);
ASSERT_TEST(TimeViewed(DS3,15,-5,timeviewed)==INVALID_INPUT);
//Line Number: 1443
ASSERT_TEST(WatchClass(DS3,15,5,-5)==INVALID_INPUT);
//Line Number: 1444
ASSERT_TEST(WatchClass(DS3,15,-5,-5)==INVALID_INPUT);
//Line Number: 1445
ASSERT_TEST(WatchClass(DS3,3,-5,-5)==INVALID_INPUT);
//Line Number: 1446
ASSERT_TEST(WatchClass(DS3,3,5,-5)==INVALID_INPUT);
//Line Number: 1447
ASSERT_TEST(WatchClass(DS3,3,-5,5)==INVALID_INPUT);
ASSERT_TEST(TimeViewed(DS3,3,-5,timeviewed)==INVALID_INPUT);
//Line Number: 1448
...
ASSERT_TEST(*classID==0);
//Line Number: 1492
ASSERT_TEST(WatchClass(DS3,5,16,5)==INVALID_INPUT);
ASSERT_TEST(TimeViewed(DS3,5,16,timeviewed)==INVALID_INPUT);
//Line Number: 1493
ASSERT_TEST(WatchClass(DS3,8,6,5)==INVALID_INPUT);
ASSERT_TEST(TimeViewed(DS3,8,6,timeviewed)==INVALID_INPUT);
//Line Number: 1494
ASSERT_TEST(WatchClass(DS3,10,6,5)==INVALID_INPUT);
ASSERT_TEST(TimeViewed(DS3,10,6,timeviewed)==INVALID_INPUT);
//Line Number: 1495
ASSERT_TEST(WatchClass(DS3,15,5,5)==FAILURE);
ASSERT_TEST(TimeViewed(DS3,15,5,timeviewed)==FAILURE);
//Line Number: 1496
ASSERT_TEST(WatchClass(DS3,15,5,5)==FAILURE);
ASSERT_TEST(TimeViewed(DS3,15,5,timeviewed)==FAILURE);
//Line Number: 1497
...
//Line Number: 1498
ASSERT_TEST(WatchClass(DS3,13,5,5)==FAILURE);
ASSERT_TEST(TimeViewed(DS3,13,5,timeviewed)==FAILURE);
//Line Number: 1499
ASSERT_TEST(WatchClass(DS3,1,8,5)==INVALID_INPUT);
ASSERT_TEST(TimeViewed(DS3,1,8,timeviewed)==INVALID_INPUT);
//Line Number: 1500
ASSERT_TEST(WatchClass(DS3,17,7,5)==INVALID_INPUT);
ASSERT_TEST(TimeViewed(DS3,17,7,timeviewed)==INVALID_INPUT);
//Line Number: 1501
ASSERT_TEST(WatchClass(DS3,17,7,5)==INVALID_INPUT);
ASSERT_TEST(TimeViewed(DS3,17,7,timeviewed)==INVALID_INPUT);
//Line Number: 1502
...
ASSERT_TEST(TimeViewed(DS3,17,7,timeviewed)==INVALID_INPUT);
//Line Number: 1503
ASSERT_TEST(WatchClass(DS3,9,5,5)==FAILURE);
ASSERT_TEST(TimeViewed(DS3,9,5,timeviewed)==FAILURE);
//Line Number: 1504
ASSERT_TEST(WatchClass(DS3,20,5,5)==FAILURE);
ASSERT_TEST(TimeViewed(DS3,20,5,timeviewed)==FAILURE);
//Line Number: 1505
ASSERT_TEST(WatchClass(DS3,18,6,5)==INVALID_INPUT);
ASSERT_TEST(TimeViewed(DS3,18,6,timeviewed)==INVALID_INPUT);
//Line Number: 1506
ASSERT_TEST(WatchClass(DS3,15,5,5)==FAILURE);
ASSERT_TEST(TimeViewed(DS3,15,5,timeviewed)==FAILURE);
//Line Number: 1507
...
ASSERT_TEST(TimeViewed(DS3,1,8,timeviewed)==INVALID_INPUT);
//Line Number: 1509
ASSERT_TEST(WatchClass(DS3,14,17,5)==INVALID_INPUT);
ASSERT_TEST(TimeViewed(DS3,14,17,timeviewed)==INVALID_INPUT);
//Line Number: 1510
ASSERT_TEST(WatchClass(DS3,4,13,5)==INVALID_INPUT);
ASSERT_TEST(TimeViewed(DS3,4,13,timeviewed)==INVALID_INPUT);
//Line Number: 1511
ASSERT_TEST(WatchClass(DS3,13,5,5)==FAILURE);
ASSERT_TEST(TimeViewed(DS3,13,5,timeviewed)==FAILURE);
//Line Number: 1512
...
ASSERT_TEST(TimeViewed(DS3,10,6,timeviewed)==INVALID_INPUT);
//Line Number: 1513
ASSERT_TEST(WatchClass(DS3,7,5,5)==FAILURE);
ASSERT_TEST(TimeViewed(DS3,7,5,timeviewed)==FAILURE);
//Line Number: 1514
ASSERT_TEST(WatchClass(DS3,12,5,5)==FAILURE);
ASSERT_TEST(TimeViewed(DS3,12,5,timeviewed)==FAILURE);
//Line Number: 1515
ASSERT_TEST(WatchClass(DS3,9,5,5)==FAILURE);
ASSERT_TEST(TimeViewed(DS3,9,5,timeviewed)==FAILURE);
//Line Number: 1516
...
ASSERT_TEST(WatchClass(DS3,6,-5,-5)==INVALID_INPUT);
//Line Number: 1525
ASSERT_TEST(WatchClass(DS3,9,-5,-5)==INVALID_INPUT);
//Line Number: 1526
ASSERT_TEST(WatchClass(DS3,9,5,-5)==INVALID_INPUT);
//Line Number: 1527
ASSERT_TEST(WatchClass(DS3,9,-5,5)==INVALID_INPUT);
ASSERT_TEST(TimeViewed(DS3,9,-5,timeviewed)==INVALID_INPUT);
//Line Number: 1528
ASSERT_TEST(WatchClass(DS3,9,5,5)==FAILURE);
ASSERT_TEST(TimeViewed(DS3,9,5,timeviewed)==FAILURE);
//Line Number: 1529
...
ASSERT_TEST(TimeViewed(DS3,20,5,timeviewed)==FAILURE);
//Line Number: 1574
ASSERT_TEST(WatchClass(DS3,11,13,5)==INVALID_INPUT);
ASSERT_TEST(TimeViewed(DS3,11,13,timeviewed)==INVALID_INPUT);
//Line Number: 1575
ASSERT_TEST(WatchClass(DS3,12,5,5)==FAILURE);
ASSERT_TEST(TimeViewed(DS3,12,5,timeviewed)==FAILURE);
//Line Number: 1576
...
//Line Number: 1578
ASSERT_TEST(WatchClass(DS3,6,17,5)==INVALID_INPUT);
ASSERT_TEST(TimeViewed(DS3,6,17,timeviewed)==INVALID_INPUT);
//Line Number: 1579
ASSERT_TEST(WatchClass(DS3,18,8,5)==INVALID_INPUT);
ASSERT_TEST(TimeViewed(DS3,18,8,timeviewed)==INVALID_INPUT);
//Line Number: 1580
ASSERT_TEST(WatchClass(DS3,8,5,5)==FAILURE);
ASSERT_TEST(TimeViewed(DS3,8,5,timeviewed)==FAILURE);
//Line Number: 1581
ASSERT_TEST(WatchClass(DS3,2,12,5)==INVALID_INPUT);
ASSERT_TEST(TimeViewed(DS3,2,12,timeviewed)==INVALID_INPUT);
//Line Number: 1582
ASSERT_TEST(WatchClass(DS3,16,5,5)==FAILURE);
ASSERT_TEST(TimeViewed(DS3,16,5,timeviewed)==FAILURE);
//Line Number: 1583
...
ASSERT_TEST(TimeViewed(DS3,12,5,timeviewed)==FAILURE);
//Line Number: 1585
ASSERT_TEST(WatchClass(DS3,17,10,5)==INVALID_INPUT);
ASSERT_TEST(TimeViewed(DS3,17,10,timeviewed)==INVALID_INPUT);
//Line Number: 1586
ASSERT_TEST(WatchClass(DS3,2,12,5)==INVALID_INPUT);
ASSERT_TEST(TimeViewed(DS3,2,12,timeviewed)==INVALID_INPUT);
//Line Number: 1587
ASSERT_TEST(WatchClass(DS3,14,5,5)==FAILURE);
ASSERT_TEST(TimeViewed(DS3,14,5,timeviewed)==FAILURE);
//Line Number: 1588
ASSERT_TEST(WatchClass(DS3,14,5,5)==FAILURE);
ASSERT_TEST(TimeViewed(DS3,14,5,timeviewed)==FAILURE);
//Line Number: 1589
...
ASSERT_TEST(TimeViewed(DS3,4,13,timeviewed)==INVALID_INPUT);
//Line Number: 1601
ASSERT_TEST(WatchClass(DS3,7,6,5)==INVALID_INPUT);
ASSERT_TEST(TimeViewed(DS3,7,6,timeviewed)==INVALID_INPUT);
//Line Number: 1602
ASSERT_TEST(WatchClass(DS3,9,6,5)==INVALID_INPUT);
ASSERT_TEST(TimeViewed(DS3,9,6,timeviewed)==INVALID_INPUT);
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@GETITH INSERTS @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
ASSERT_TEST(*classID==0);
//Line Number: 1623
ASSERT_TEST(WatchClass(DS3,19,0,-5)==INVALID_INPUT);
//Line Number: 1624
ASSERT_TEST(GetIthWatchedClass(DS3,6,courseID,classID)==SUCCESS);
ASSERT_TEST(*courseID==5);
ASSERT_TEST(*classID==1);
...
ASSERT_TEST(*classID==0);
//Line Number: 1633
ASSERT_TEST(AddCourse(DS3,6)==FAILURE);
//Line Number: 1634
ASSERT_TEST(GetIthWatchedClass(DS3,15,courseID,classID)==FAILURE);
//Line Number: 1635
...
ASSERT_TEST(*classID==2);
//Line Number: 1655
ASSERT_TEST(WatchClass(DS3,2,2,14)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,2,2,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==14);
//Line Number: 1656
ASSERT_TEST(GetIthWatchedClass(DS3,9,courseID,classID)==SUCCESS);
ASSERT_TEST(*courseID==5);
...
ASSERT_TEST(*classID==2);
//Line Number: 1674
ASSERT_TEST(WatchClass(DS3,11,5,6)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,11,5,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==6);
//Line Number: 1675
ASSERT_TEST(GetIthWatchedClass(DS3,10,courseID,classID)==SUCCESS);
ASSERT_TEST(*courseID==11);
...
ASSERT_TEST(*classID==9);
//Line Number: 1768
ASSERT_TEST(WatchClass(DS3,18,1,2)==SUCCESS);
...
ASSERT_TEST(*classID==1);
//Line Number: 1778
ASSERT_TEST(WatchClass(DS3,3,0,-5)==INVALID_INPUT);
//Line Number: 1779
ASSERT_TEST(GetIthWatchedClass(DS3,7,courseID,classID)==SUCCESS);
ASSERT_TEST(*courseID==5);
ASSERT_TEST(*classID==1);
...
ASSERT_TEST(*classID==2);
//Line Number: 1797
ASSERT_TEST(WatchClass(DS3,5,11,14)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,5,11,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==14);
//Line Number: 1798
ASSERT_TEST(GetIthWatchedClass(DS3,1,courseID,classID)==SUCCESS);
ASSERT_TEST(*courseID==6);
...
ASSERT_TEST(RemoveCourse(DS3,11)==SUCCESS);
//Line Number: 1808
ASSERT_TEST(GetIthWatchedClass(DS3,17,courseID,classID)==FAILURE);
//Line Number: 1809
ASSERT_TEST(GetIthWatchedClass(DS3,12,courseID,classID)==SUCCESS);
ASSERT_TEST(*courseID==18);
ASSERT_TEST(*classID==1);
...
ASSERT_TEST(*classID==2);
//Line Number: 1828
ASSERT_TEST(AddCourse(DS3,7)==FAILURE);
//Line Number: 1829
ASSERT_TEST(GetIthWatchedClass(DS3,8,courseID,classID)==SUCCESS);
ASSERT_TEST(*courseID==5);
ASSERT_TEST(*classID==1);
...
//Line Number: 1839
ASSERT_TEST(RemoveCourse(DS3,13)==FAILURE);
//Line Number: 1840
ASSERT_TEST(GetIthWatchedClass(DS3,2,courseID,classID)==SUCCESS);
ASSERT_TEST(*courseID==5);
ASSERT_TEST(*classID==0);
...
ASSERT_TEST(*classID==1);
//Line Number: 1876
ASSERT_TEST(AddCourse(DS3,18)==FAILURE);
//Line Number: 1877
ASSERT_TEST(GetIthWatchedClass(DS3,17,courseID,classID)==FAILURE);
//Line Number: 1878
ASSERT_TEST(WatchClass(DS3,14,0,-5)==INVALID_INPUT);
//Line Number: 1879
ASSERT_TEST(GetIthWatchedClass(DS3,17,courseID,classID)==FAILURE);
//Line Number: 1880
ASSERT_TEST(GetIthWatchedClass(DS3,17,courseID,classID)==FAILURE);
...
ASSERT_TEST(*classID==0);
//Line Number: 1937
ASSERT_TEST(WatchClass(DS3,20,0,5)==FAILURE);
ASSERT_TEST(TimeViewed(DS3,20,0,timeviewed)==FAILURE);
//Line Number: 1938
ASSERT_TEST(GetIthWatchedClass(DS3,6,courseID,classID)==SUCCESS);
ASSERT_TEST(*courseID==6);
ASSERT_TEST(*classID==1);
...
ASSERT_TEST(*classID==2);
//Line Number: 1947
ASSERT_TEST(AddCourse(DS3,15)==FAILURE);
//Line Number: 1948
ASSERT_TEST(GetIthWatchedClass(DS3,2,courseID,classID)==SUCCESS);
ASSERT_TEST(*courseID==5);
ASSERT_TEST(*classID==0);
...
ASSERT_TEST(*classID==0);
//Line Number: 2024
ASSERT_TEST(RemoveCourse(DS3,11)==FAILURE);
//Line Number: 2025
ASSERT_TEST(GetIthWatchedClass(DS3,10,courseID,classID)==SUCCESS);
ASSERT_TEST(*courseID==5);
ASSERT_TEST(*classID==9);
...
ASSERT_TEST(*classID==1);
//Line Number: 2034
ASSERT_TEST(RemoveCourse(DS3,12)==FAILURE);
//Line Number: 2035
ASSERT_TEST(GetIthWatchedClass(DS3,-5,courseID,classID)==INVALID_INPUT);
//Line Number: 2036
ASSERT_TEST(GetIthWatchedClass(DS3,8,courseID,classID)==SUCCESS);
...
ASSERT_TEST(*classID==1);
//Line Number: 2073
ASSERT_TEST(WatchClass(DS3,5,10,7)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,5,10,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==7);
//Line Number: 2074
...
ASSERT_TEST(*classID==0);
//Line Number: 2093
ASSERT_TEST(WatchClass(DS3,13,0,-5)==INVALID_INPUT);
//Line Number: 2094
ASSERT_TEST(GetIthWatchedClass(DS3,1,courseID,classID)==SUCCESS);
ASSERT_TEST(*courseID==6);
ASSERT_TEST(*classID==2);
...
ASSERT_TEST(*classID==0);
//Line Number: 2103
ASSERT_TEST(WatchClass(DS3,19,0,5)==FAILURE);
ASSERT_TEST(TimeViewed(DS3,19,0,timeviewed)==FAILURE);
//Line Number: 2104
ASSERT_TEST(GetIthWatchedClass(DS3,13,courseID,classID)==SUCCESS);
ASSERT_TEST(*courseID==18);
ASSERT_TEST(*classID==1);
...
ASSERT_TEST(GetIthWatchedClass(DS3,18,courseID,classID)==FAILURE);
//Line Number: 2221
ASSERT_TEST(WatchClass(DS3,10,4,16)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,10,4,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==16);
//Line Number: 2222
ASSERT_TEST(GetIthWatchedClass(DS3,4,courseID,classID)==SUCCESS);
ASSERT_TEST(*courseID==2);
...
ASSERT_TEST(*classID==11);
//Line Number: 2261
ASSERT_TEST(RemoveCourse(DS3,20)==FAILURE);
//Line Number: 2262
ASSERT_TEST(GetIthWatchedClass(DS3,19,courseID,classID)==FAILURE);
//Line Number: 2263
ASSERT_TEST(AddCourse(DS3,10)==FAILURE);
...
ASSERT_TEST(*classID==9);
//Line Number: 2300
ASSERT_TEST(WatchClass(DS3,17,3,8)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,17,3,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==8);
//Line Number: 2301
...
ASSERT_TEST(*classID==1);
//Line Number: 2319
ASSERT_TEST(WatchClass(DS3,11,0,-5)==INVALID_INPUT);
//Line Number: 2320
ASSERT_TEST(GetIthWatchedClass(DS3,7,courseID,classID)==SUCCESS);
ASSERT_TEST(*courseID==6);
ASSERT_TEST(*classID==1);
...
ASSERT_TEST(*classID==0);
//Line Number: 2338
ASSERT_TEST(WatchClass(DS3,6,10,6)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,6,10,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==6);
//Line Number: 2339
...
ASSERT_TEST(*classID==2);
//Line Number: 2349
ASSERT_TEST(WatchClass(DS3,10,6,6)==SUCCESS);
ASSERT_TEST(TimeViewed(DS3,10,6,timeviewed)==SUCCESS);
ASSERT_TEST(*timeviewed==6);
//Line Number: 2350
ASSERT_TEST(GetIthWatchedClass(DS3,9,courseID,classID)==SUCCESS);
ASSERT_TEST(*courseID==5);

...
void CoursesTable::addCourse( int course_id)
{
    ...
    Triplet<int,int,std::shared_ptr<DynamicArray<Pair<int,int>>>> course_info 
    (course_id,0,std::shared_ptr<DynamicArray<Pair<int,int>>> (new DynamicArray<Pair<int,int>>));
